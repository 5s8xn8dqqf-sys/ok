...
document.addEventListener("DOMContentLoaded", () => {
    // Đã sửa: Truyền id 'panelContainer' hợp lệ dưới dạng chuỗi (String)
    touchManager = new TouchSensitivityManager('panelContainer', {
...
class TouchSensitivityManager {
    ...
    getMultiplier() {
        const value = this.sensitivityLevels[this.currentLevel] || 500;
        return value / 100; // 100 -> 1x, 500 -> 5x, 1100 -> 11x
    }
